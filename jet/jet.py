...
def parse_arguments():
    ...
    job_parser.add_argument('--image-pull-secrets', action='append', nargs='+', help='Image pull secrets')
    ...
    job_parser.add_argument('--pyenv', help='Path to Python environment. Supported envs: conda, and uv.')
    ...
    job_parser.add_argument('--job-labels', action='append', nargs='+', help='Job labels in key=value format')
    job_parser.add_argument('--pod-labels', action='append', nargs='+', help='Pod labels in key=value format')
    ...
    jupyter_parser.add_argument('--image-pull-secrets', action='append', nargs='+', help='Image pull secrets')
    jupyter_parser.add_argument('--pyenv', help='Path to Python environment. Supported envs: conda, and uv.')
    ...
    jupyter_parser.add_argument('--job-labels', action='append', nargs='+', help='Job labels in key=value format')
    jupyter_parser.add_argument('--pod-labels', action='append', nargs='+', help='Pod labels in key=value format')
    ...
    debug_parser.add_argument('--image-pull-secrets', action='append', nargs='+', help='Image pull secrets')
    ...
    debug_parser.add_argument('--pyenv', help='Path to Python environment. Supported envs: conda, and uv.')
    ...
    debug_parser.add_argument('--job-labels', action='append', nargs='+', help='Job labels in key=value format')
    debug_parser.add_argument('--pod-labels', action='append', nargs='+', help='Pod labels in key=value format')
